...
<!-- claims:tests:start -->
**715 tests across 91 test files**, all green on `@teambrain/cli@0.5.0`. This line is generated by `scripts/claims.mjs` from a real `vitest run`, and CI fails if it drifts from the suite.
<!-- claims:tests:end -->
